...
[example.webm](https://github.com/user-attachments/assets/af4846f4-29a4-4813-9040-b70109215ff8)
...
- src/avx2prng.h : AVX2_PRNG_Generator - Pure AVX2 random generator without use of slow module functions.
- src/particleengine.cpp : ParticleEngine::tick function - AVX2 accelerated processing of particles.
